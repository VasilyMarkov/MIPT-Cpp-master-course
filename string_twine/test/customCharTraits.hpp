...
struct TestCharTraits<char> {
    ...
    static constexpr std::array<char, 4> substr_value = {'b', 'c', 'd', '\0'};
};
...
struct TestCharTraits<char16_t> {
    ...
    static constexpr std::array<char16_t, 4> substr_value = {u'b', u'c', u'd', '\0'};
};
...
struct TestCharTraits<char32_t> {
    ...
    static constexpr std::array<char32_t, 4> substr_value = {U'b', U'c', U'd', '\0'};
};
...
struct TestCharTraits<wchar_t> {
    ...
    static constexpr std::array<wchar_t, 4> substr_value = {L'b', L'c', L'd', '\0'};
};
